...
> Your answer as text
chr (1): group     (Character)
dbl (4): id, weight, age, fat   (Double)
...
```{r}
readr::read_delim("data/blood_fat.csv", col_types=cols(age=col_integer(), id ="i"), show_col_types=FALSE)
...
```{r}
readr::read_delim("data/blood_fat.csv", col_types=cols(age="i", id= "i", weight="_"),show_col_types=FALSE)
